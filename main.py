...
import csv
from filelock import FileLock  # Bibliothek für das Sperren von Dateien
...
lock_file_path = status_file_path + ".lock"  # Datei-Sperrung für Status-File
...
# Funktion zum Laden des Status aus der JSON-Datei mit Sperrung
def load_status():
    with FileLock(lock_file_path):  # Dateisperrung für den Zugriff
...
# Funktion zum Speichern des Status in die JSON-Datei mit Sperrung
